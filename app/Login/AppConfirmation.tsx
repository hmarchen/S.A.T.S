  ...
  return (
    ...
    >
      <View style={styles.transparentContainer}>
        ...
        <Text style={[styles.paragraph, { marginTop: 10 }]}>Thank you for submitting your request. Your appointment with the Business Faculty office has been requested.</Text>
        ...
        <Text style={[styles.paragraph, { color: '#FFD700' }]}> If you need further assistance, visit the Business Faculty office during working hours.</Text>
        <Pressable
